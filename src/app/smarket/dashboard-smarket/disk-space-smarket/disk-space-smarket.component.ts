...
import { disk_space } from '../dashboard-smarket.data';

@Component({
  selector: 'app-disk-space-smarket',
  templateUrl: './disk-space-smarket.component.html',
  encapsulation: ViewEncapsulation.None
})
export class DiskSpaceSmarketComponent {
