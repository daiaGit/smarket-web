...
@Component({
  selector: 'app-consumidores-smarket',
  templateUrl: './consumidores-smarket.component.html',
  styleUrls: ['./consumidores-smarket.component.scss'],
...
export class ConsumidoresSmarketComponent implements OnInit {
