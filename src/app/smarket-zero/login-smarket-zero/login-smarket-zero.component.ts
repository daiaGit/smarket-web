...
@Component({
  selector: 'app-login-smarket-zero',
  templateUrl: './login-smarket-zero.component.html',
  styleUrls: ['./login-smarket-zero.component.scss'],
  providers: [
    AcessoService
  ],
...
export class LoginSmarketZeroComponent implements OnInit {
