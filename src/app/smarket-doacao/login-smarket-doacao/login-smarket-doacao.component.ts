...
@Component({
  selector: 'app-login-smarket-doacao',
  templateUrl: './login-smarket-doacao.component.html',
  styleUrls: ['./login-smarket-doacao.component.scss'],
  providers: [
    AcessoService
  ],
...
export class LoginSmarketDoacaoComponent implements OnInit {
