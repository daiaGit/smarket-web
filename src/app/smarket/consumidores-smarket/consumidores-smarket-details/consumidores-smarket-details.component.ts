...
@Component({
  selector: 'app-consumidores-smarket-details',
  templateUrl: './consumidores-smarket-details.component.html',
  styleUrls: ['./consumidores-smarket-details.component.scss'],
  providers: [
    ConsumidorService
  ],
  encapsulation: ViewEncapsulation.None
})
export class ConsumidoresSmarketDetailsComponent implements OnInit {
