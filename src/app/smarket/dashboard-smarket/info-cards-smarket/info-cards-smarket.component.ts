...
import { orders, products, customers, refunds } from '../dashboard-smarket.data';

@Component({
  selector: 'app-info-cards-smarket',
  templateUrl: './info-cards-smarket.component.html',
  encapsulation: ViewEncapsulation.None
})
export class InfoCardsSmarketComponent  {
  public orders: any[];
  public products: any[];
