...
import { countries } from '../dashboard-smarket.data';

@Component({
  selector: 'app-visitors-smarket',
  templateUrl: './visitors-smarket.component.html',
  styleUrls: ['./visitors-smarket.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class VisitorsSmarketComponent  {
