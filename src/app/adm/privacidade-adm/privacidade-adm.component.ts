...
@Component({
  selector: 'app-privacidade-adm',
  templateUrl: './privacidade-adm.component.html',
  styleUrls: ['./privacidade-adm.component.scss'],
  providers: [
    AcessoService
  ],
...
export class PrivacidadeAdmComponent implements OnInit {
